...
export default function SearchBox({coordinates,city, updateLocation,updateCoordinates,updateWeatherInfo, ColorValue, updateBgColor, MenuState, updateMenuState}) {
    ...
    <div style={{display: "flex" , justifyContent:"center"}}>
        ...
        >   
            <IconButton sx={{ p: '10px', color:ColorValue.fColor }} aria-label="menu">
              <SideMenu MenuState={MenuState} updateMenuState={updateMenuState} ColorValue={ColorValue} updateBgColor={updateBgColor}/>
            </IconButton>
            <InputBase
